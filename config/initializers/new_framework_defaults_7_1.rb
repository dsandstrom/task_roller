...
# Internet Explorer.
# If you need to support Internet Explorer, add back
...
#   #double_quoted_string_literals_are_accepted for more details.
#++
Rails.application.config.active_record
...
# https://guides.rubyonrails.org/v7.1/configuring.html
#   #config-active-support-message-serializer
#
