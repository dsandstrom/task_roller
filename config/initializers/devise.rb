...
Devise.setup do |config|
  ...
  # config.secret_key =
  #   '5978f7042f9f7332b038ce075483d3ff2d63c686723e206672d8828803f5994e3cab7b7'\
  #   '017e40119d7ad6c83fc348ec728fca7f0cb0469928863055f236e8ed2'
  ...
  # config.pepper =
  #  '875f82bd604607021d91ddfcb40e8a317652c60ba925ad13721a92a4fea1f07127a5ae4'\
  #  'c9e95675ac09136e8e8d44a3065baf6411269b218d853558140a4b5e5'
  ...
  config.omniauth :github, ENV.fetch('GITHUB_KEY', nil),
                  ENV.fetch('GITHUB_SECRET', nil), scope: 'user,public_repo'
  ...
  # NOTE: not required if using webpacker
